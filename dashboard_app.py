...
app.layout = html.Div([
    ...
    html.Hr(),
    html.Div(children='I was planning to make the table with filters so it can be used to filter results for queries such as: "Companies with voting rights greater than 10" '
                      'there is some issue with the current setup and I am unable to add that option, I might be able to fix in a day or two; for now it is just a simple paginated table'),
